...
const PortfolioSection = ({ data }) => {
  ...
  const getData = (imgLink, title, subTitle, video) => {
    setTempData([1, imgLink, title, subTitle, video]);
    setModal(true);
  }
  ...
  return (
    <>
      ...
      {modal === true ? <Modal img={tempData[1]} title={tempData[2]} subTitle={tempData[3]} video={tempData[4]} modalClose={modalClose} /> : ""}
    </>
  );
};
